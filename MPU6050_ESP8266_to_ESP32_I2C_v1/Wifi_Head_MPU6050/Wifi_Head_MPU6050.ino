...
const char HTML_CONFIG_PANEL[] PROGMEM = R"rawliteral(
        <div class="config-panel" id="configPanel">
            ...
            <div style="margin: 15px 0;">
                ...
                <input type="text" class="config-input" id="ipInput" placeholder="192.168.14.55" value="192.168.14.55">
...
const char HTML_SCRIPT[] PROGMEM = R"rawliteral(
    <script>
        ...
        function loadDefaultIP() {
            document.getElementById('ipInput').value = '192.168.14.55';
